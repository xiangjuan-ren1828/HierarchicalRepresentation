function ClusterRep_ChoiceModel_main_HPC_tmp2(iExp, iMode, iSub)
...
MList   = {'SRheurProcessTraceInitWfixed0_half'}; % 'SRheurProcessTraceFixedW', 'SRheurProcessTraceFixedW0', 'SRheurProcessTraceInitWfree'; 'heurProcessTraceDecayParam', 'SR_AttModNow'; 'objTP', 'MaxEntropy', 'MaxEntropy', 'SR', 'heurProcessProb', 'heurProcessTraceWin', 'heurProcessTrace', 'heurProcessTraceAvg', 'SRheurProcessProb', 'SRheurProcessTraceWin', 'SRheurProcessTrace', 'SRheurProcessTraceAvg', 'SRheurProcessTraceCluster', 'SRheurProcessTraceDistort'
