...
MList   = {'heurProcessTraceDecay'}; % 'objTP', 'MaxEntropy', 'MaxEntropy', 'SR', 'heurProcessProb', 'heurProcessTraceWin', 'heurProcessTrace', 'heurProcessTraceAvg', 'SRheurProcessProb', 'SRheurProcessTraceWin', 'SRheurProcessTrace', 'SRheurProcessTraceAvg', 'SRheurProcessTraceCluster', 'SRheurProcessTraceDistort'
